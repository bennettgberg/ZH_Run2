...
def getArgs() :
    ...
    parser.add_argument("-f","--inFile",default='MCsamples_2016_v7.csv',help="Input file name.") 
...
#    outLines.append("mkdir -p {0:s}_{2:s}/{1:s}_{2:s}\ncd {0:s}_{2:s}/{1:s}_{2:s}\n".format(args.selection,nickname,era))
#    outLines.append("python ../../makeCondorsam.py --dataSet {0:s} --nickName {1:s} --mode {4:s} --year {5:s} -c 5 -s {6:s} -g {7:d} \n".format(dataset,nickname, args.csv, args.pileup, mode,era, args.selection, args.genmatch))
